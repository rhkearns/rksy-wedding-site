	...
	return (
		<>
			...
			<div id="story-block">
				...
				<img src={bosCommons} alt="Boston Commons" id="bos-commons" />
				<p>
				...
				<p>
					...
					pulling up to their computers on Sunday afternoons, pulling a book off
					their shelves, and diving into their stories. Ryan became known for
					creating funny voices for familiar characters, and enjoyed hearing the
					suppressed laughter from others. While he was finding new ways to add
					his personality to a story they all knew by heart, Sam was charmed by
					his smile and his sense of humor. Steadily she started looking forward
					to read-aloud so she could see him.
				</p>{' '}
				<p>
					...
					waited anxiously for him to respond: Samantha, 12:13am: “Hey! I just
					wanted to tell you that I love the voices you do during the read
					alouds! I know we haven't interacted on there much but I wanted to let
					you know” Ryan, 10:24am: “Haha glad you like them! I’ve got a couple
					prepped for this week, an old friend returning and a new one that
					everyone is going to hate” (Looking back at this over three years
					later, Ryan has no idea what voices he’s referring to).
				</p>
				<p>
					{' '}
				...
				<div id="photo-group-1">
					<div id="photo-group-1-text">

					<p>
						They decided to conduct their first date via Zoom; when they finally
						hit “end call” after 6 hours, Ryan thought to himself, “Ok, this
						could be something”. That pattern continued; each time they spoke,
						neither seemed to want to hang up. They learned what they had in
						common, including but not limited to shared love for disappointing
						sports teams, proper bagels and pizza (don’t try to pretend that
						stuff in DC was worth eating), and fantastical stories that suck you
						in and keep hold of you for decades.
					</p>{' '}
					<p>
						Eventually, with a Thanksgiving in New Jersey coming up, Ryan
						suggested meeting in person, which Sam was eager to accept…at first;
						in the days leading up to the meet, the thoughts began to spiral.
						“What if we don’t get along? What if we have nothing to talk about?
						What if he smells bad?????” Finally the Saturday after Thanksgiving
						came. Ryan packed a few day’s belongings in his backpack, and made
						his way into Manhattan, following the familiar route he took to high
						school, hopeful that this trip would be the first of many.
					</p>{' '}
					</div>
					<img src={firstTrip} id="first-trip-nyc" />
				</div>
				<p>
				...
				<p>
					{' '}
					They settled into a new routine. Texting or calling daily, Zoom dates
					every so often, and Facetiming every night before bed. It was during
					one of these Facetimes that Ryan admitted that he knew if they were to
					make it, he would have to move to New York; Sam, knowing that he
					didn’t want to live in Manhattan, decided to compromise, and said
					“well, we can live in Brooklyn.”
				</p>{' '}
				<p>
					After months of back and forth, New Years and Valentines in Virginia,
					trips to New York in January and March, New traditions were made,
					holidays celebrated, and they met each other’s friends and families.
				</p>
				<p>
				...
				<p>
					They settled again into another new routine, spending the work week
					apart, and weekends together in New York. Ryan began enjoying his time
					in the big city, something he wasn’t sure was going to happen. But the
					continual job hunting was weighing on him. The stay in East Hanover
					was only supposed to last a few months, but there was no end in sight.
					Finally, after Ryan voiced his regret that he changed his major from
					computer science in college, Sam provided the spark: “you can just do
					a software engineering bootcamp.” So that’s what he did, though the
					delay in starting a new career meant that Sam had to follow his lead
					and moved into her parent’s spare room and eventually bit the bullet
					and joined Ryan in NJ when her parents moved to Connecticut. When Ryan
				...
				<p>
					A year of forming a new life together followed, during which Ryan
					began planning and designing a ring. Their daily walk in Prospect Park
					emerged as the obvious time to propose. So on a beautiful fall
					evening, on their daily walk, Ryan directed them to their summer
					reading spot on the main lawn. He began saying nice things about Sam
					and their life together, and Sam was caught completely by surprise -
					but happily said yes when he pulled out a ring.
				</p>
				<p>
